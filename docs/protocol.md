        # Dpma: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/dpma.git

        ## Objective

        DPMA (Differentially Private Meta-Analysis) implements privacy-preserving evidence synthesis using differential privacy mechanisms, protecting individual study contributions.
        ...
        - Code: https://github.com/mahmood726-cyber/dpma.git
        - Dashboard: N/A
